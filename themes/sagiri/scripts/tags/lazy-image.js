...
function lazyImage(args) {
  ...
  var image = ['<span itemprop="image" itemscope itemtype="http://schema.org/ImageObject"><img itemprop="url image" src="https://cdn.jsdelivr.net/gh/abozanona/abozanona.me/images/loading.gif" data-original="' + src + '" class="full-image"'];
